...
Determine, with proof, the location of $M$ such that $p(M)$ is maximal. Let $\mu(ABC)$ denote the maximum value. For which triangles $ABC$ is the value of $\mu(ABC)$ maximal?
