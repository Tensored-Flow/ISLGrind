% country: Canada
Let $n$ be a fixed integer with $n \geq 2$. We say that two polynomials $P$ and $Q$ with real coefficients are \emph{block-similar} if for each $i \in \{1, 2, \ldots, n\}$ the sequences
\[
